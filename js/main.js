...
var Board = function () {
  function Board(row, col) {
    var goal = arguments.length <= 2 || arguments[2] === undefined ? null : arguments[2];
  ...
  _createClass(Board, [{
    ...
    key: 'getGoalIndex',
    value: function getGoalIndex(x, y) {
      return this.goal ? this.goal[y][x] : null;
    }
  }, {
    key: 'setIndex',
    value: function setIndex(x, y, val) {
      this.grid[y][x] = val;
    }
  }, {
    key: 'setAll',
    value: function setAll(locations) {
    ...
    value: function draw(context, x, y, w, h) {
      ...
      if (typeof this.cursor !== 'undefined') this.cursor.draw(context, x, y, cellWidth, cellHeight);
    }
  }, {
    key: 'update',
    value: function update() {
      if (typeof this.cursor !== 'undefined') this.cursor.update();
    }
  }]);
...
var Cursor = function () {
  function Cursor(board) {
    ...
    var side = arguments.length <= 3 || arguments[3] === undefined ? Cursor.side.LEFT : arguments[3];
    ...
    this.next = {};
    // Keyboard input
    this.kb = new _Keyboarder2.default();
  ...
  _createClass(Cursor, [{
    key: "setNext",
    value: function setNext(cursor) {
      for (var _len = arguments.length, sides = Array(_len > 1 ? _len - 1 : 0), _key = 1; _key < _len; _key++) {
        sides[_key - 1] = arguments[_key];
      }

      if (sides.length === 0) sides = Cursor.side;
      for (var s in sides) {
    ...
    key: "move",
    value: function move(side) {
      // Don't move if a key is being held down
      if (this.takingInput) return;
      // Don't move if the move is not allowed
      if (!this.moveX && (side === Cursor.side.RIGHT || side === Cursor.side.LEFT)) {
        this.disabled = true;
        return;
      }
      if (!this.moveY && (side === Cursor.side.UP || side === Cursor.side.DOWN)) {
        this.disabled = true;
        return;
      }
    ...
    key: "passOver",
    value: function passOver(side) {
      var block = this.board.getIndex(this.x, this.y);
      if (block !== null) if (this.next[side.name] !== undefined) this.next[side.name].blockReceived = block;
      this.board.setIndex(this.x, this.y, null);
    }
  }, {
    key: "update",
    value: function update() {
      if (this.kb.isDown(_Keyboarder2.default.key.LEFT)) {
        this.move(Cursor.side.LEFT);
        this.takingInput = true;
      } else if (this.kb.isDown(_Keyboarder2.default.key.RIGHT)) {
        this.move(Cursor.side.RIGHT);
        this.takingInput = true;
      } else if (this.kb.isDown(_Keyboarder2.default.key.UP)) {
        this.move(Cursor.side.UP);
        this.takingInput = true;
      } else if (this.kb.isDown(_Keyboarder2.default.key.DOWN)) {
    ...
    key: "draw",
    value: function draw(context, x, y, cellWidth, cellHeight) {
...
},{"./Keyboarder":295}],294:[function(require,module,exports){
'use strict';
...
var Game = function () {
  function Game(canvasId) {
    ...
    this.level = new _Level2.default(this.width, this.height, goalBoard);
  }
...
},{"./Level":296}],295:[function(require,module,exports){
"use strict";
...
var Keyboarder = function () {
  function Keyboarder() {
    ...
    window.addEventListener("keydown", function (e) {
      return _this.keyState[e.keyCode] = true;
    });
...
var Level = function () {
  function Level(width, height, goal) {
    var _marked = [startingBoardFrom].map(regeneratorRuntime.mark);
    ...
    // Board 4: Bottom left
    var board1 = new _Board2.default(boardHeight, boardWidth);
    var board2 = new _Board2.default(boardHeight, 1);
    var board3 = new _Board2.default(boardHeight, boardWidth, goal);
    var board4 = new _Board2.default(1, boardWidth);
    ...
    function startingBoardFrom(goal) {
      var vals, _iteratorNormalCompletion, _didIteratorError, _iteratorError, _iterator, _step, row, _iteratorNormalCompletion3, _didIteratorError3, _iteratorError3, _iterator3, _step3, cell, pairs, i, j, _iteratorNormalCompletion2, _didIteratorError2, _iteratorError2, _iterator2, _step2, val, ret;

      return regeneratorRuntime.wrap(function startingBoardFrom$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              _context.prev = 4;
              _iterator = goal[Symbol.iterator]();
            ...
            case 6:
              ...
              for (_iterator3 = row[Symbol.iterator](); !(_iteratorNormalCompletion3 = (_step3 = _iterator3.next()).done); _iteratorNormalCompletion3 = true) {
                cell = _step3.value;

                if (cell !== null) vals.push(cell);
              }_context.next = 19;
              break;
            ...
            case 44:
              ...
              _context.prev = 51;
              _iterator2 = vals[Symbol.iterator]();
      ...
      }, _marked[0], this, [[4, 32, 36, 44], [11, 15, 19, 27], [20,, 22, 26], [37,, 39, 43], [51, 64, 68, 76], [69,, 71, 75]]);
    }

    board1.setAll(Array.from(startingBoardFrom(goal)));

    var cursor1 = new _Cursor2.default(board1, 0, 0, _Cursor2.default.side.UP);
    var cursor2 = new _Cursor2.default(board2, 0, 0, _Cursor2.default.side.UP);
    var cursor3 = new _Cursor2.default(board3, 0, 0, _Cursor2.default.side.UP);
    var cursor4 = new _Cursor2.default(board4, 0, 0, _Cursor2.default.side.LEFT);
    cursor1.setNext(cursor2, _Cursor2.default.side.UP, _Cursor2.default.side.DOWN);
    cursor1.setNext(cursor4, _Cursor2.default.side.LEFT, _Cursor2.default.side.RIGHT);
  ...
  _createClass(Level, [{
    ...
    value: function update() {
      ...
      try {
        for (var _iterator4 = this.boards[Symbol.iterator](), _step4; !(_iteratorNormalCompletion4 = (_step4 = _iterator4.next()).done); _iteratorNormalCompletion4 = true) {
          var b = _step4.value;
    ...
    value: function draw(context) {
      ...
      try {
        for (var _iterator5 = this.boards[Symbol.iterator](), _step5; !(_iteratorNormalCompletion5 = (_step5 = _iterator5.next()).done); _iteratorNormalCompletion5 = true) {
          var b = _step5.value;
...
},{"./Board":292,"./Cursor":293}],297:[function(require,module,exports){
'use strict';
